public class Main
{
    ...
    {
        char elsoKarakter = s.charAt(0);

            String maradek = s.substring(1).replace(elsoKarakter, '*');


        return elsoKarakter+maradek;
    }
    ...
    static String mixUp(String a, String b)
    {
        ...
        String masodik2 = b.substring(2);
        String elso2 = a.substring(2);
        return masodik+elso2+" "+elso+masodik2;
    }
